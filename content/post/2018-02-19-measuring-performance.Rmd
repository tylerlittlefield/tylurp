...
Now that we've gathered the possible solutions to this problem, we can create a reproducible dataset. This way others can use it. Additionally, I want to make it easy to increase the size of the data:
...
bms <- microbenchmark::microbenchmark(
  ...
  reshape_dcast = reshape_decast(stocksm),
